class TennisGame2:
    ...
    def won_point(self, player_name):
        # Naprawiony błąd: używamy dynamicznych nazw zamiast sztywnego "player1"
    ...
    def _get_equal_score(self):
        if self.p1_points < 3:
            return f"{self.point_names[self.p1_points]}-All"
        return "Deuce"
    ...
    def _get_regular_score(self):
        # Uproszczenie dziesiątek linii kodu do dwóch zmiennych
        p1_res = self.point_names[self.p1_points]
        p2_res = self.point_names[self.p2_points]
